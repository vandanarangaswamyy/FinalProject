...
public class AddListingJPanel extends javax.swing.JPanel {
    ...
    public AddListingJPanel(JPanel userProcessContainer, UserAccount account, Organization permHousingOrganization, Enterprise enterprise, StudentDirectory vd,EcoSystem business) 
 {
        initComponents();
   ...
   public HouseListingDirectory getDir() {
    ...
    private void initComponents() {
        ...
        add(txtArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, 270, -1));

        jLabel2.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Street Name");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, -1, -1));
        add(txtStreetName, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 170, 270, -1));

        jLabel3.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Door Number");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, -1, -1));
        add(txtDoorNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 240, 270, -1));

        jLabel4.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("City");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 300, -1, -1));
        add(txtCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 300, 270, -1));

        jLabel5.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Pin Code");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 360, -1, -1));
        add(txtPinCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 360, 270, -1));
        ...
        add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 430, 130, 40));

        jLabel6.setFont(new java.awt.Font("Niramit", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Add Permanent House Listing");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, 40));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 550, 90, -1));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try{
         ...
         Integer.parseInt(txtPinCode.getText());
          ...
          JOptionPane.showMessageDialog(null,"  Pincode cannot be a string");
           return;
         }
        try{
                      if(!txtDoorNumber.getText().equals(""))
         Integer.parseInt(txtDoorNumber.getText());
          ...
          JOptionPane.showMessageDialog(null,"  Door number cannot be a string");
           return;
         }
        ...
        JOptionPane.showMessageDialog(null, "Listing has been added. Students can now view it.", "Information", JOptionPane.INFORMATION_MESSAGE);
